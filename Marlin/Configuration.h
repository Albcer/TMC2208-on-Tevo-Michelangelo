...
#define STRING_CONFIG_H_AUTHOR "(Phantom, TEVO Michelangelo)" // Who made the changes.
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 75    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT 75    // Y point for Z homing when homing all axis (G28).
#endif
